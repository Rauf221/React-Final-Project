...
const PhonesTechLarge = ({ image, category, title1, title2, author, date, authorImage, type, ...props }) => {
  return (
    <div className="h-[100%] w-full relative overflow-hidden rounded-2xl">
      <img
        className="w-[100%] h-[95%] -z-10 object-cover transition-all rounded-2xl duration-500 hover:scale-105"
        src={image}
        alt=""
      />
      <div
      ...
      <div className="absolute bottom-44 left-3 ">
      ...
      <div className="absolute z-50 bottom-8 left-3">
